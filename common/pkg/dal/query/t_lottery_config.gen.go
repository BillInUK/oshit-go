...
func newLotteryConfig(db *gorm.DB, opts ...gen.DOOption) lotteryConfig {
	...
	_lotteryConfig.RewardAccount = field.NewString(tableName, "reward_account")
	_lotteryConfig.CostAccount = field.NewString(tableName, "cost_account")
	_lotteryConfig.CostAmount = field.NewFloat64(tableName, "cost_amount")
	_lotteryConfig.CostFeeRate = field.NewFloat64(tableName, "cost_fee_rate")
	_lotteryConfig.CreatedAt = field.NewTime(tableName, "created_at")
	_lotteryConfig.UpdatedAt = field.NewTime(tableName, "updated_at")
...
func (l *lotteryConfig) updateTableName(table string) *lotteryConfig {
	...
	l.RewardAccount = field.NewString(table, "reward_account")
	l.CostAccount = field.NewString(table, "cost_account")
	l.CostAmount = field.NewFloat64(table, "cost_amount")
	l.CostFeeRate = field.NewFloat64(table, "cost_fee_rate")
...
func (l *lotteryConfig) fillFieldMap() {
	...
	l.fieldMap["reward_account"] = l.RewardAccount
	l.fieldMap["cost_account"] = l.CostAccount
	l.fieldMap["cost_amount"] = l.CostAmount
	l.fieldMap["cost_fee_rate"] = l.CostFeeRate
