...
const TableNameFeeStatisticsDefault = "t_fee_statistics_default"

// FeeStatisticsDefault mapped from table <t_fee_statistics_default>
...
// TableName FeeStatisticsDefault's table name
func (*FeeStatisticsDefault) TableName() string {
	return TableNameFeeStatisticsDefault
}
