...
const TableNameUserDailyExchangeQuota = "t_user_daily_exchange_quota"

// UserDailyExchangeQuota mapped from table <t_user_daily_exchange_quota>
...
// TableName UserDailyExchangeQuota's table name
func (*UserDailyExchangeQuota) TableName() string {
	return TableNameUserDailyExchangeQuota
}
