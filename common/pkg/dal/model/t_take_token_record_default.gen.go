...
const TableNameTakeTokenRecordDefault = "t_take_token_record_default"

// TakeTokenRecordDefault mapped from table <t_take_token_record_default>
...
// TableName TakeTokenRecordDefault's table name
func (*TakeTokenRecordDefault) TableName() string {
	return TableNameTakeTokenRecordDefault
}
