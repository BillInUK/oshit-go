...
const TableNameLotteryRewardDefault = "t_lottery_reward_default"

// LotteryRewardDefault mapped from table <t_lottery_reward_default>
...
// TableName LotteryRewardDefault's table name
func (*LotteryRewardDefault) TableName() string {
	return TableNameLotteryRewardDefault
}
