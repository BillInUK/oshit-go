...
const TableNameStakeBuyTokenDefault = "t_stake_buy_token_default"

// StakeBuyTokenDefault mapped from table <t_stake_buy_token_default>
...
// TableName StakeBuyTokenDefault's table name
func (*StakeBuyTokenDefault) TableName() string {
	return TableNameStakeBuyTokenDefault
}
