...
type ServiceContext struct {
	...
	Redis       *redis.Client
	Ctx         context.Context
	AccountCli  base_pb.AccountService
...
func initAccountCli(cfg config.NacosConfig) (base_pb.AccountService, error) {
	...
	accountClient, err := base_pb.NewAccountService(cli)
	if err != nil {
