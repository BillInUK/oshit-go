...
func (l *PosRewardLogic) decodeSOLTx(tx *solana.Transaction, txInfo *types.ClaimPosRewardTxInfo) (*entity.DecodedSolanaTransaction, error) {
...
func (l *PosRewardLogic) checkSOLTx(decodedTx *entity.DecodedSolanaTransaction, txInfo *types.ClaimPosRewardTxInfo) error {
