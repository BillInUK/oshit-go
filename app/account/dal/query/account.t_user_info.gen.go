...
import (
	...
	"oshit-go/app/account/dal/model"
)
...
func newUserInfo(db *gorm.DB, opts ...gen.DOOption) userInfo {
	...
	_userInfo.Status = field.NewInt16(tableName, "status")
...
type userInfo struct {
	...
	Phone     field.String // 手机号（唯一）
	Email     field.String // 邮箱（唯一）
	Password  field.String // 密码（演示用，实际需加密）
	Status    field.Int16  // 状态：1-正常 0-禁用
