...
(service,sub_service,address,webhook,mq_group,mq_topic,hook_type,confirm,multi_sign,created_at,updated_at)
values
    ('Stake','StakeLeaderReward','2yRkofKW7xKRbN79MHKGX8HFyuHZEtTJDhTwAQjJHnMX','','Stake','ServiceTransaction',0,true,true,now(),now());
...
(service,sub_service,encrypted_key,created_at,updated_at)
values
    ('Stake','StakeLeaderReward','al2M3Q+0pu2FDePJvtnaCE4mtPZnTck1BXGcSCZtWgiSPXOveWaSuMKo6i4qapQcHqdMdWp6i3aPjkx/R96aC/AF5Je13r7Lmokpf7/LlxcoZzt+nJxtEmVlTDS1jful93CCIBjp0Yx+b0k1Cf4jWx6FQu9KdkzRqXBIoggoHuw=',NOW(),NOW());
...
(service,sub_service,native_account,pda_account,until_tx_id,before_tx_id,slot,created_at,updated_at)
values
    ('Stake','StakeLeaderReward', '2yRkofKW7xKRbN79MHKGX8HFyuHZEtTJDhTwAQjJHnMX','HqAp7uFZAckGA9jKFCZXg7rq1GX9CB2kwpGBKoq5geg6','29dZDL5PFTaBYdqUz7E3gFBJsLzMsHckgwSiga2y1c2RBL95t2RL4y6PRepaZkfQcqxQhRCpe2RKPDn7UUyL9U7p','',453414783,now(),now());
