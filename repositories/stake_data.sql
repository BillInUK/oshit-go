...
-- 总区域经理表
insert into public.t_stake_total_area_leader(native_account,share,created_at,updated_at)values('G6xxsFzFHPhLCUg4Qq8aun2EcQ3hTcLvwb6pUWMsVBKa',7,now(),now());
insert into public.t_stake_total_area_leader(native_account,share,created_at,updated_at)values('CH6nEGuiYF5kenkavr4KMLEvY6DP7cKgQKrh9t2UiHX9',3,now(),now());

-- 区域经理表
insert into public.t_stake_area_leader(native_account,level,share,leader,created_at,updated_at)values('FgPU2MGLkX278ZD2XhNaJBwVd7q2CjHa9Y9Em3u1s7Ur',2,null,null,now(),now());
insert into public.t_stake_area_leader(native_account,level,share,leader,created_at,updated_at)values('DGMNe2KYDB8fbxdcxipHwmzMqJk34dMZxdWxguZC4xrC',2,null,null,now(),now());

insert into public.t_stake_area_leader(native_account,level,share,leader,created_at,updated_at)values('D8Dibj91XjosaCjiWbk2zHQvvuFDTUvvjEeT351Z7fK9',1,null,null,now(),now());
insert into public.t_stake_area_leader(native_account,level,share,leader,created_at,updated_at)values('9ti8HrjakPuRmFa2Q6Lj7UopKuCuS2gSGLNk5umZ7X8v',1,null,null,now(),now());
insert into public.t_stake_area_leader(native_account,level,share,leader,created_at,updated_at)values('4tJJv3RiQfwL4vdRsdYJK12K1yoirw3b2n1RTZxKacwn',1,null,'FgPU2MGLkX278ZD2XhNaJBwVd7q2CjHa9Y9Em3u1s7Ur',now(),now());
insert into public.t_stake_area_leader(native_account,level,share,leader,created_at,updated_at)values('GVfKwyUXYuVhh65v8Q232dLhdm51eBfsLZPGAsWK6npk',1,null,'FgPU2MGLkX278ZD2XhNaJBwVd7q2CjHa9Y9Em3u1s7Ur',now(),now());
insert into public.t_stake_area_leader(native_account,level,share,leader,created_at,updated_at)values('EzehTETE4o8Jua5pCAUk7AHV5Zt3QL1a2D9vfE1ii6HK',1,null,'DGMNe2KYDB8fbxdcxipHwmzMqJk34dMZxdWxguZC4xrC',now(),now());
